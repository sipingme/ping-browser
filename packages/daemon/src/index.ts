...
import { DAEMON_PORT, DAEMON_HOST } from "@ping-browser/shared";
import { HttpServer } from "./http-server.js";

const PID_FILE_PATH = "/tmp/ping-browser.pid";
...
function parseOptions(): DaemonOptions {
  ...
  if (values.help) {
    console.error(`
ping-browser-daemon - HTTP Server Daemon for ping-browser

Usage:
  ping-browser-daemon [options]
